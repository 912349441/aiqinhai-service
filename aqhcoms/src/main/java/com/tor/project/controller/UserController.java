...
public class UserController {
    ...
    @ApiOperation(value = "列表查询", notes = "User列表")
    @ApiImplicitParams({
    ...
    @ApiOperation( value = "添加一个实例",notes = "添加user" )
    ...
    @ApiOperation( value = "根据ID删除",notes = "通过id删除user" )
    @ApiImplicitParam( name="id" , value="id" , paramType = "path",dataType = "String",required = true)
    ...
    @ApiOperation( value = "修改",notes = "修改user" )
